...
class Main_course(Starter):
    def __init__(self, name, menu):
        super().__init__(name, menu)
        self.main_course_bill = 0
        self.main_course_items = []
...
class Desserts(Drinks):
    ...
    def desserts(self):
        ...
        if self.dessert_choice == "1":
            ...
            self.desserts_items.append("Chocolate Cake")
...
class Bill(Desserts):
    ...
    def bill(self):
        self.total_bill = self.starter_bill + self.main_course_bill + self.drinks_bill + self.desserts_bill
        ...
        print("| Starters      >>>>>> ", self.starter_items)
        print("| Main Course   >>>>>> ", self.main_course_items)
        print("| Drinks        >>>>>> ", self.drinks_items)
        print("| Desserts      >>>>>> ", self.desserts_items)
        print("|----------------------------------------------|")
...
menu="menu of the resturant"
obj1=Starter(name,menu)
obj2=Main_course(name,menu)
obj3=Drinks(name,menu)
obj4=Desserts(name,menu)
obj5=Bill(name,menu)
while(True):
